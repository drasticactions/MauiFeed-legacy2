// <copyright file="SidebarViewController.DragAndDrop.cs" company="Drastic Actions">
...
#pragma warning restore CA1416 // プラットフォームの互換性を検証
    ...
    public async void PerformDrop(UICollectionView collectionView, IUICollectionViewDropCoordinator coordinator)
    {
        ...
        {
            await this.folderService.AddFeedToFolderAsync(folder.FeedFolder, sidebarItem.FeedListItem);
        }
    }
}
#endif
